...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  contentPad: { padding: 10, paddingBottom: 66 },
  ...
  sectionTitle: { color: "#f8fafc", fontWeight: "900", fontSize: 18, marginTop: 16, marginBottom: 10 },
  newsLine: { color: "#e2e8f0", backgroundColor: "#1f2937", borderRadius: 8, padding: 10, marginBottom: 7, fontSize: 13 },
  row: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: "#1f2937", padding: 10, borderRadius: 8, marginBottom: 6, gap: 8 },
  rowLeft: { color: "#e2e8f0", flex: 1, fontSize: 13 },
  rowRight: { color: "#fbbf24", fontWeight: "800", fontSize: 13 },
  listCard: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "#1f2937", borderColor: "#334155", borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: 8 },
  playerListCard: { flexDirection: "column", alignItems: "stretch" },
  playerCardHeader: { flexDirection: "row", alignItems: "center", gap: 10 },
  selected: { borderColor: "#f59e0b", backgroundColor: "#283242" },
  ...
  portfolioAlert: { backgroundColor: "#10251b", borderColor: "#235c38", borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: 10 },
  leaderPanel: { backgroundColor: "#111827", borderColor: "#334155", borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: 10 },
  portfolioAlertTitle: { color: "#fbbf24", fontSize: 12, fontWeight: "900", marginBottom: 5 },
  portfolioAlertText: { color: "#dbeafe", fontSize: 11, lineHeight: 16, fontWeight: "800" },
  marketFilterRow: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginBottom: 10 },
  marketFilterChip: { flexGrow: 1, minHeight: 34, borderRadius: 8, backgroundColor: "#1f2937", borderColor: "#334155", borderWidth: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 8 },
  ...
  scoutActionPanel: { backgroundColor: "#101827", borderColor: "rgba(56,189,248,0.25)", borderWidth: 1, borderRadius: 8, padding: 10, marginBottom: 10, gap: 8 },
  ...
  portraitImageWrap: { overflow: "hidden", borderWidth: 1, borderColor: "#64748b", backgroundColor: "#0f172a", position: "relative" },
  ...
  cardTitle: { color: "#f8fafc", fontWeight: "800", fontSize: 14 },
  valueText: { color: "#fbbf24", fontSize: 12, marginTop: 3 },
  ...
  playerActionModeTabs: { flexDirection: "row", gap: 5, backgroundColor: "#0f172a", borderRadius: 8, padding: 4, borderWidth: 1, borderColor: "rgba(148,163,184,0.16)" },
  playerActionModeTab: { flex: 1, minHeight: 32, borderRadius: 7, alignItems: "center", justifyContent: "center", backgroundColor: "transparent" },
  ...
  buttonSubText: { color: "#cbd5e1", fontSize: 9, fontWeight: "800", marginTop: 2 },
  eventCard: { backgroundColor: "#1f2937", borderColor: "#475569", borderWidth: 1, borderRadius: 8, padding: 14, marginBottom: 10 },
  ...
  goodButton: { backgroundColor: "#166534", borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12, minWidth: 82, alignItems: "center" },
  warnButton: { backgroundColor: "#b45309", borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12, minWidth: 82, alignItems: "center" },
  ghostButton: { borderColor: "#64748b", borderWidth: 1, borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12, minWidth: 82, alignItems: "center" },
  primaryMini: { backgroundColor: "#2563eb", borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12, minWidth: 82, alignItems: "center" },
  dangerMini: { backgroundColor: "#991b1b", borderRadius: 8, paddingVertical: 10, paddingHorizontal: 12, minWidth: 82, alignItems: "center" },
